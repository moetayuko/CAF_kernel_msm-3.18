...
#ifdef CM36283_SENSOR
        { "CM36283 Light sensor",
          "CAPELLA",
          1, SENSORS_LIGHT_HANDLE,
          SENSOR_TYPE_LIGHT, 3277.0f, 1.0f, 0.75f, 0, { } },
        { "CM36283 Proximity sensor",
          "CAPELLA",
...
#ifdef CM36283_SENSOR
    mSensors[cm] = new CmSensor();
    mPollFds[cm].fd = mSensors[cm]->getFd();
    mPollFds[cm].events = POLLIN;
    mPollFds[cm].revents = 0;
#else
