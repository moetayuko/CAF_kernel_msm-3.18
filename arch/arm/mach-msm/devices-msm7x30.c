...
struct clk_lookup msm_clocks_7x30[] = {
	...
	CLK_PCOM("emdh_clk",	EMDH_CLK,	"msm_mddi.1", OFF | CLK_MINMAX),
	CLK_PCOM("emdh_pclk",	EMDH_P_CLK,	"msm_mddi.1", OFF),
	...
	CLK_PCOM("i2c_clk",	I2C_CLK,	"msm_i2c.0", OFF),
	CLK_PCOM("i2c_clk",	I2C_2_CLK,	"msm_i2c.0", OFF),
	...
	CLK_PCOM("mddi_pclk",	PMDH_P_CLK,	"msm_mddi.0", OFF | CLK_MINMAX),
	CLK_PCOM("mdp_clk",	MDP_CLK,	"msm_mdp.0", OFF),
	CLK_PCOM("mdp_pclk",	MDP_P_CLK,	"msm_mdp.0", OFF),
	CLK_PCOM("lcdc_pclk_clk", MDP_LCDC_PCLK_CLK, "msm_mdp.0", 0),
	CLK_PCOM("lcdc_pad_pclk_clk", MDP_LCDC_PAD_PCLK_CLK, "msm_mdp.0", 0),
	CLK_PCOM("mdp_vsync_clk",	MDP_VSYNC_CLK,  "msm_mdp.0", 0),
	...
	CLK_PCOM("spi_clk",	SPI_CLK,	"msm_spi.0", 0),
	CLK_PCOM("spi_pclk",	SPI_P_CLK,	"msm_spi.0", 0),
	...
	CLK_PCOM("qup_clk",	QUP_I2C_CLK,	"qup_i2c.4", OFF),
	CLK_PCOM("qup_pclk",	QUP_I2C_P_CLK,	"qup_i2c.4", OFF),
