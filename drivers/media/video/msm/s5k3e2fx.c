...
/*
#define TAKE_QTR_SIZE
*/

/* 20090703 Steven_Yeh Mask non-necessary setting. Start
#ifndef TAKE_QTR_SIZE
...
/* 20090703 Steven_Yeh Mask non-necessary setting. Start
#else
#define S5K3E2FX_FULL_SIZE_WIDTH	1296
#define S5K3E2FX_FULL_SIZE_HEIGHT	972
#endif
20090703 Steven_Yeh Mask non-necessary setting. End */
...
/*Wilson Add for Steven's request Start*/
...
/* 20090703 Steven_Yeh add the X-Y addr setting position. Start */
...
/* 20090703 Steven_Yeh add the X-Y addr setting position. End */
/* 20090703 Steven_Yeh Change the setting position. Start */
  /* Frame format */
...
/* 20090703 Steven_Yeh Change the setting position. End */
  /* Binning */
...
/* 20090703 Steven_Yeh Add LC Preview/Snapshot difference register. End */
  ...
  { /* Snapshot */
	...
	0x02,  /* fine_integration_time         REG=0x0200 */
	0x03,  /* coarse_integration_time       REG=0x0202 */
	/* 20090703 Steven_Yeh Add LC Preview/Snapshot diff register. Start */
	...
	/* 20090703 Steven_Yeh Add LC Preview/Snapshot diff register. End */
...
static int32_t s5k3e2fx_i2c_read_b(unsigned short saddr, unsigned short raddr,
	unsigned short *rdata)
{
	int32_t rc = 0;
	unsigned char buf[4];
...
{
/* 20090703 Steven_Yeh For disable HW standby. Start
		...
		struct msm_sensor_ctrl *s)
{
	...
	/*20090706 Steven's lens correction*/
