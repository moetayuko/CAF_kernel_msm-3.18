...
extern int  fts_glove_init(struct i2c_client *client);
extern int  fts_glove_exit(struct i2c_client *client);

extern int  fts_enter_cover_mode(struct i2c_client *client, int mode);
extern int  fts_cover_init(struct i2c_client *client);
extern int  fts_cover_exit(struct i2c_client *client);

extern int  fts_enter_charger_mode(struct i2c_client *client, int mode);
extern int  fts_charger_init(struct i2c_client *client);
extern int  fts_charger_exit(struct i2c_client *client);
