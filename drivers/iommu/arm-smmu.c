...
static int
arm_vsmmu_gr_read(struct kvm_vcpu *vcpu, struct kvm_io_device *this, gpa_t addr,
		  int len, void *val)
{
 ...
 */
static int
arm_vsmmu_cb_read(struct kvm_vcpu *vcpu, struct kvm_io_device *this, gpa_t addr,
		  int len, void *val)
{
	struct arm_vsmmu_device *vsmmu
		= container_of(&this->ops, struct arm_vsmmu_device,
